...
<nav class="navbar navbar-inverse" role="navigation">
  <div class="container-fluid">
    <ul class="nav navbar-nav navbar-left">
      <li>
        <a style="font-size: 26px;">Music Event System -- Admin</a>
      </li>
    </ul>
...
<div class="container-fluid">
  <div class="row">
    <div class="col-sm-2">
      ...
      <a href="javascript:void(0)" class="list-group-item active" onclick="change('/planner?method=list',0)">
      ...
      <a href="javascript:void(0)" class="list-group-item" onclick="change('/venue?method=list',2)">
						<span class="" aria-hidden="true">
    ...
    <!--right content-->
    <iframe style="width: 81%; height: 800px; border: 0px;" src="/planner?method=list"></iframe>
  </div>
</div>
<div class="footer">
  <p class="text-center">
